...
public class DraggableHash implements EventHash {

    private Element helper;
    private At offset;
    private At pos;

    public DraggableHash(JavaScriptObject hash) {
    ...
    public native void fromJavaScriptObject(JavaScriptObject jso) /*-{
        ...
        this.@nz.co.doltech.gwtjui.interactions.client.events.hash.DraggableHash::setPos(Lcom/google/gwt/core/client/JavaScriptObject;)(jso.position);
    }-*/;
}
